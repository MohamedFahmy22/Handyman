...
<?php
    ...
    $stmt = $coon->prepare("SELECT * FROM user JOIN notification ON user.userID = notification.userID WHERE notification.notificationID=$id AND n_status=0");
    $stmt->execute();
            ...
            <div class="tab-pane active"  role="tabpanel">
                <div class="is-container">
                    ...
                    <div class="row" style="margin-left: 40%;">
                        <div class="col-md-2">
                            <a href="?do=Reject&id=<?php echo $row['notificationID']?>" class="btn btn-danger" style="margin-left: 23%;">Reject</a>
                        </div>
                        <div class="col-md-6">
                            <a href="?do=Accept&id=<?php echo $row['notificationID']?>" class="btn btn-success">Accept</a>
                        </div>
                    </div>
                </div>
            </div>            
